...
double getSamplingRate(std::string cmdb, std::string env){
    ...
    if((cur_timestamp - lastUpdatedTime) > 180000 ){
      ...
      std::string cur_url = env == "prod"?"http://internal-ms-service-discovery-887102973.ap-northeast-2.elb.amazonaws.com/":"http://internal-ms-consul-alb-416054892.ap-northeast-2.elb.amazonaws.com:8500";
